...
namespace project.Application.Features.Command.WorkTasks.RemoveTaskLabel
{
    public sealed class RemoveTaskLabelHandler : IRequestHandler<RemoveTaskLabelCommand, Result>
    {
        private readonly IWorkTaskRepository _taskRepository;
        private readonly IUnitOfWork _unitOfWork;
        public RemoveTaskLabelHandler(IWorkTaskRepository taskRepository, IUnitOfWork unitOfWork)
        {
